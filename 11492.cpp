...
int cons_lang , M , word_estoy_index , word_index , costo , lang_estoy , word_to_index , costo_to;
...
int dijkstra( int lang_from , int lang_to )
{
  ...
  {
    word_index = lang_words[lang_from][i];
